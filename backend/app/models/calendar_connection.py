...
class CalendarConnection(Base, UUIDPk, OrgScoped, TimestampMixin, SoftDeleteMixin):
    ...
    access_token_ct: Mapped[str] = mapped_column(String(4000), nullable=False)  # encrypted at rest
    refresh_token_ct: Mapped[str | None] = mapped_column(String(4000), nullable=True)
